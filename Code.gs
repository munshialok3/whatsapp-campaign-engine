...
const CONFIG = {
  ...
  WABA_MAP: {
    ...
    "ACCOUNT_3": "YOUR_WABA_ID_3",
    "ACCOUNT_4": "YOUR_WABA_ID_4",
    "ACCOUNT_5": "YOUR_WABA_ID_5",
    "ACCOUNT_6": "YOUR_WABA_ID_6",
    "ACCOUNT_7": "YOUR_WABA_ID_7",
    "ACCOUNT_8": "YOUR_WABA_ID_8",
    "ACCOUNT_9": "YOUR_WABA_ID_9"
  },
  ...
  DEFAULTS: {
    ...
    BUTTON_URL_TEMPLATE: "https://your-domain.com/{{1}}"
  },

  MAX_BODY_PARAMS:               5,
  MIN_BODY_PARAMS:               1,
  HANDLE_REFRESH_THRESHOLD_DAYS: 7,
  ALERT_EMAILS_DEFAULT:          "your-team@yourcompany.com",

  CT_PROVIDER_MAP: {
    "ACCOUNT_1":  0000000000,
    "ACCOUNT_2": 0000000000,
    "ACCOUNT_3": 0000000000,
    "ACCOUNT_4": 0000000000,
    "ACCOUNT_5": 0000000000,
    "ACCOUNT_6": 0000000000,
    "ACCOUNT_7": 0000000000,
    "ACCOUNT_8": 0000000000,
    "ACCOUNT_9": 0000000000
  },

  CT_BASE:       "https://your-crm-dashboard.com",
  CT_ACCOUNT_ID: "YOUR_CRM_ACCOUNT_ID"
};
...
function handleProxyAlert_(params) {
  ...
  if (action === "SWAPPED") {
    ...
    body =
      ...
      `3. Resume the campaign on Your CRM`;
  } else {
...
function setHeaderImageUrlMenu() {
  ...
  const r       = ui.prompt("Set Header Image URL",
    "Paste the CDN URL for the header image.\n\n" +
...
function testCtEndpoint() {
  const ui = SpreadsheetApp.getUi();
  const r  = ui.prompt("Test CT Import Endpoint", "Enter AC Code (e.g. ACCOUNT_15):", ui.ButtonSet.OK_CANCEL);
  if (r.getSelectedButton() !== ui.Button.OK) return;
